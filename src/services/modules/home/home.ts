...
export function getPhoneJobTypeList() {
  return appRequest.get({
    url: '/home/phone/job/type'
  })
}
...
export function getHomeCompanyDetail(id: string) {
  return appRequest.get<IHomeCompanyDetailData>({
    url: `/home/company/detail/${id}`
  })
}

export function getCompanyDetailType(id: string) {
  return appRequest.get({
...
export function getHomeJobDetail(id: string) {
...
export function addResumeToJob(id: string, userId: number) {
  return appRequest.get({
...
export function searchJob(text: string) {
  return appRequest.post({
    url: '/home/search',
    data: {
      text
